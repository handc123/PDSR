...
class EdgeDisplacement(Net):
    ...
    def forward(self, x, name=None, path4feature4gcn=None):
        ...
        if name == None:
            ...
            print("Features")
            print(os.path.join(path4feature4gcn, name))
            np.save(os.path.join(path4feature4gcn, name), features.cpu().numpy())
            return edge_out, dp_out
